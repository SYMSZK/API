...
public class Get04 extends JsonPlaceHolderBaseUrl {
    ...
    public void get04(){
        //Set the URL
        // String url = "https://jsonplaceholder.typicode.com/todos"; ===>base url
        //biz RequestSpecification yaparak jsonplaceholder a yapacaımız tum reuestleri specifica hale getirdik bunları yaparak
        spec.pathParam("first","todos");

        //Set the expected data

        //Send the request and get the response
        Response response = given().spec(spec).when().get("/{first}"); //spec bize base url belirtiyor
        response.prettyPrint(); //json formatında bir list oldugunu gorduk
        //otoresin token alma yetki alma e
